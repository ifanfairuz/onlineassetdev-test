...
const variant = computed(() => {
  switch (props.variant) {
    case 'ghost':
      return 'bg-background text-foreground hover:bg-neutral-100 disabled:bg-background disabled:text-foreground/50'

    case 'outline':
      return 'bg-transparent text-foreground hover:bg-neutral-100 border border-neutral-300 disabled:bg-transparent disabled:text-foreground/50 disabled:border-neutral-300/50'
